...
class Page1(Frame):
    ...
    def chk_btn1_onclick(self):
        ...
        if checked:
            self.qty_entry1.configure(state=tk.NORMAL)
        else:
            self.qty_entry1.configure(state=tk.NORMAL)
        self.enable_btn()
    ...
    def chk_btn2_onclick(self):
        ...
        if checked:
            self.qty_entry2.configure(state=tk.NORMAL)
        else:
            self.qty_entry2.configure(state=tk.NORMAL)
        self.enable_btn()
    ...
    def chk_btn3_onclick(self):
        ...
        if checked:
            self.qty_entry3.configure(state=tk.NORMAL)
        else:
            self.qty_entry3.configure(state=tk.NORMAL)
        self.enable_btn()
    ...
    def chk_btn4_onclick(self):
        ...
        if checked:
            self.qty_entry4.configure(state=tk.NORMAL)
        else:
            self.qty_entry4.configure(state=tk.NORMAL)
        self.enable_btn()
    ...
    def chk_btn5_onclick(self):
        ...
        if checked:
            self.qty_entry5.configure(state=tk.NORMAL)
        else:
            self.qty_entry5.configure(state=tk.NORMAL)
        self.enable_btn()
    ...
    def enable_btn(self):
        if any((self.chk_btn_var1.get(), self.chk_btn_var2.get(),
            ...
            self.gen_receipt_btn.configure(state=tk.NORMAL)
        else:
            self.gen_receipt_btn.configure(state=tk.DISABLED)
    ...
    def _set_body(self):
        self.chk_btn_var1 = tk.BooleanVar()
        self.chk_btn_var2 = tk.BooleanVar()
        self.chk_btn_var3 = tk.BooleanVar()
        self.chk_btn_var4 = tk.BooleanVar()
        self.chk_btn_var5 = tk.BooleanVar()

        # order column
        self.chk_btn1 = tk.Checkbutton(self, text="", variable=self.chk_btn_var1,
                                    command=self.chk_btn1_onclick)
        self.chk_btn1.grid(row=1, column=0, sticky='NW')
        self.chk_btn2 = tk.Checkbutton(self, text="", variable=self.chk_btn_var2,
                                    command=self.chk_btn2_onclick)
        self.chk_btn2.grid(row=2, column=0, sticky='NW')
        self.chk_btn3 = tk.Checkbutton(self, text="", variable=self.chk_btn_var3,
                                    command=self.chk_btn3_onclick)
        self.chk_btn3.grid(row=3, column=0, sticky='NW')
        self.chk_btn4 = tk.Checkbutton(self, text="", variable=self.chk_btn_var4,
                                    command=self.chk_btn4_onclick)
        self.chk_btn4.grid(row=4, column=0, sticky='NW')
        self.chk_btn5 = tk.Checkbutton(self, text="", variable=self.chk_btn_var5,
        ...
        # quantity column
        self.qty_entry1 = Entry(self, state=tk.DISABLED)
        self.qty_entry1.grid(row=1, column=3)
        self.qty_entry2 = Entry(self, state=tk.DISABLED)
        self.qty_entry2.grid(row=2, column=3)
        self.qty_entry3 = Entry(self, state=tk.DISABLED)
        self.qty_entry3.grid(row=3, column=3)
        self.qty_entry4 = Entry(self, state=tk.DISABLED)
        self.qty_entry4.grid(row=4, column=3)
        self.qty_entry5 = Entry(self, state=tk.DISABLED)
    ...
    def on_gen_receipt_btn_click(self):
        ...
        if any((qty1, qty2, qty3, qty4, qty5)):
            ...
            tk.messagebox.showwarning("Quantities", "Empty quantity fields")
    ...
    def clear_all(self):
        ...
        self.qty_entry1.delete(0, tk.END)
        self.qty_entry2.delete(0, tk.END)
        self.qty_entry3.delete(0, tk.END)
        self.qty_entry4.delete(0, tk.END)
        self.qty_entry5.delete(0, tk.END)

        self.qty_entry1.configure(state=tk.DISABLED)
        self.qty_entry2.configure(state=tk.DISABLED)
        self.qty_entry3.configure(state=tk.DISABLED)
        self.qty_entry4.configure(state=tk.DISABLED)
        self.qty_entry5.configure(state=tk.DISABLED)
        self.gen_receipt_btn.configure(state=tk.DISABLED)
